...
<style>
    ...
    .login-brand h1 { font-size: 20px; font-weight: 700; color: var(--text-main); }
    .login-brand p { font-size: 13px; color: var(--text-muted); margin-top: 4px; }
    .form-group { margin-bottom: 18px; }
    .form-group label { display: block; font-size: 12px; font-weight: 600; margin-bottom: 8px; color: var(--text-main); }
...
<div class="login-container">
    <div class="login-card">
        <div class="login-brand">
            ...
            <h1>Masuk ke E-Voting</h1>
            <p>Masukkan nomor NISN & Tanggal Lahir Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="text" name="nisn" required value="{{ old('nisn') }}" placeholder="2414XXXX" inputmode="numeric" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
